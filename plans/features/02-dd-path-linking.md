...
> **DROPPED** — Existing 309 catalog entries will be archived and regenerated by the codex SN build pipeline. Path linking happens during generation, not as a retrofit.

**Repository:** imas-standard-names  
**Wave:** ~~1~~ N/A  
**Status:** Dropped (2026-04-08)
