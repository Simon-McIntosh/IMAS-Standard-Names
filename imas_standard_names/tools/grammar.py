    ...
    async def get_grammar(self, section: str | None = None, ctx: Context | None = None):
        ...
        vocabulary["physical_base"] = {
            ...
            "guidance": {
                ...
                "component_usage": "Use component segment for vector field directions (radial_magnetic_field)",
    ...
    def _get_grammar_overview(self) -> dict:
        ...
        return {
            ...
            "composition_rules": {
                ...
                "template_application": "Templates transform tokens BEFORE joining: 'radial' + 'magnetic_field' -> 'radial_magnetic_field'",
