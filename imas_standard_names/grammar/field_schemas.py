...
FIELD_CONSTRAINTS: dict[str, dict[str, Any]] = {
    ...
    "cocos_transformation_type": {
        "required": False,
        "type": "string",
        "examples": ["psi_like", "ip_like"],
    },
}

FIELD_GUIDANCE: dict[str, dict[str, Any]] = {
    "name": {
        "validation": "Must follow grammar canonical pattern. Use get_grammar for composition rules.",
        "common_mistakes": [
...
TYPE_SPECIFIC_REQUIREMENTS: dict[str, dict[str, Any]] = {
    "scalar": {
        "required_fields": ["name", "description", "documentation", "unit"],
        "field_overrides": {
    ...
    "tensor": {
        ...
        "description": "Rank-2+ tensor quantities (metric tensor, stress tensor, conductivity tensor)",
    },
    "complex": {
        "required_fields": ["name", "description", "documentation", "unit"],
        "field_overrides": {
        ...
        "description": "Complex-valued quantities (real + imaginary parts, or magnitude + phase)",
    },
    "metadata": {
...
try:
    ...
    KIND_MODELS: dict[Kind, type] = {
        ...
        Kind.tensor: StandardNameTensorEntry,
        Kind.complex: StandardNameComplexEntry,
