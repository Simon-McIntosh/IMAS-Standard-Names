...
class Position(StrEnum):
    ...
    REFLECTOMETER_CUTOFF_POSITION = "reflectometer_cutoff_position"
    CHARGE_EXCHANGE_CHANNEL = "charge_exchange_channel"
    THOMSON_SCATTERING_CHANNEL_POSITION = "thomson_scattering_channel_position"
    LANGMUIR_PROBE_POSITION = "langmuir_probe_position"
    CALORIMETRY_COMPONENT = "calorimetry_component"
