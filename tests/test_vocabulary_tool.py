...
@pytest.fixture
def get_vocabulary_tokens_tool():
...
class TestVocabularyManageTool:
    ...
    @pytest.mark.anyio
    async def test_list_all_vocabularies(self, get_vocabulary_tokens_tool):
        """Test listing all vocabularies."""
        result = await get_vocabulary_tokens_tool.get_vocabulary_tokens()
    ...
    @pytest.mark.anyio
    async def test_list_specific_vocabulary(self, get_vocabulary_tokens_tool):
...
class TestVocabularyToolIntegration:
    ...
    @pytest.mark.anyio
    async def test_with_standard_names_catalog(self, get_vocabulary_tokens_tool):
